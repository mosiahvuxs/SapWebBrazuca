...
public class HistoricoPedidoVendaLinhaDAO {
	...
	public void inserirComBroker(PedidoVendaLinha model, TSDataBaseBrokerIf broker) throws TSApplicationException {
		...
		broker.setPropertySQL("historicopedidovendalinhadao.inserirComBroker", model.getInterfaceId(), model.getPedidoVenda().getInterfaceId(), model.getItem().getId(), model.getItem().getEstoque().getId(),model.getQuantidade(), model.getValorUnitario(),
